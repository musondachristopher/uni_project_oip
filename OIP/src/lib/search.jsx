...
export function SearchBar() {
	...
	return (
		<form onSubmit={handleSubmit} className="bg-gray-50 rounded-full text-gray-500 flex items-center gap-1 pl-2 md:w-1/3 w-3/5">
			<input 
			...
			<button className="p-1 rounded-full bg-primary-400 hover:bg-primary-500 ">
